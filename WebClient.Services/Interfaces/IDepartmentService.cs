...
namespace WebClient.Services.Interfaces
{
    public interface IDepartmentService
    {
        ...
        Task<IEnumerable<Department>> GetTreeDepartmentsdWithTerm(int userId, int departmentId, int idDepartmentEnd = -1);
        ...
        Task UpdateEmailAsync(EmailDepartmentVM emailDepartment, int userId);
